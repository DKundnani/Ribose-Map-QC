...
[![check](https://github.com/DKundnani/FeatureCorr/actions/workflows/check-standard.yaml/badge.svg)](https://github.com/DKundnani/FeatureCorr/actions/workflows/check-standard.yaml)
[![Open in Code
Ocean](https://codeocean.com/codeocean-assets/badge/open-in-code-ocean.svg)](https://codeocean.com/capsule/7549295/tree)
<!-- badges: end -->

Percentage and Composition of rNMPs from ribose-seq output 
...
```
Creating enviroment using r_env.yml with:
